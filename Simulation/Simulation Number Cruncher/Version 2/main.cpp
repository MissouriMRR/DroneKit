...
void Engine()
{
    ...
    for(int index1 = 0; index1 < DRONE_NUMBER; index1++)
    {
        ...
        {
            float Rotation_To_Closest_Obs = TO_DEGREES * atan2(Array_Of_Frames[Current_Frame].Obstacle_Robots[Closest_Obs_Robot].Y - Current_Drone->Y,
                                   Array_Of_Frames[Current_Frame].Obstacle_Robots[Closest_Obs_Robot].X - Current_Drone->X);
